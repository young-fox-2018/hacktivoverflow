            ...
            <div class="modal-wrapper">
                <div class="modal-container">
                    ...
                    <div class="modal-footer">
                        ...
                        <button @click="updateAnswer" class="btn btn-outline-warning btn-sm">Update</button>
...
<script>
    ...
    export default {
        ...
        props: ['dataAnswer', 'questionId'],
        data() {
            return {
                content:  this.dataAnswer.content,
                loading: false,
            };
        },
        components: {
        ...
        methods: {
            updateAnswer() {
                this.loading = true;
                apiHacktiv.put(`/questions/answers/${this.questionId}/${this.dataAnswer._id}`,
                    {
                        contentAnswer: this.content,
                    },
                    {
                        headers: {
